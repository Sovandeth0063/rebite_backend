...
CREATE TABLE IF NOT EXISTS orders (
  ...
  merchant_logo TEXT NOT NULL,
  merchant_address TEXT NOT NULL,
  rescue_bag_id VARCHAR(100) NOT NULL REFERENCES rescue_bags(id) ON DELETE CASCADE,
  ...
  order_status VARCHAR(50) NOT NULL CHECK (order_status IN ('RESERVED', 'READY_FOR_PICKUP', 'COMPLETED', 'CANCELLED', 'NO_SHOW')),
  qr_code_url TEXT,
